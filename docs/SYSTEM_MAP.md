...
flowchart TD
    ...
    DETECT --> MEM["SEMANTIC PATTERN MEMORY<br/>verified patterns in .boundary/knowledge/<br/>saves customer tokens"]
...
flowchart TD
    ...
    subgraph CORE["Core engine"]
        ...
        INTEL["intelligence.py<br/>BoundaryIntelligence · Decision"]
