...
"""
Boundary MCP (Model Context Protocol) Server.

Exposes Boundary's autonomous software maintenance engine to AI assistants
...
TOOLS: list[dict[str, Any]] = [
    ...
    {
        "name": "boundary_analyze_dependency",
    ...
    {
        "name": "boundary_repair_and_verify",
...
def handle_tool_call(name: str, arguments: dict[str, Any]) -> dict[str, Any]:
    ...
    elif name == "boundary_analyze_dependency":
    ...
    elif name == "boundary_repair_and_verify":
            ...
            "content": [
                {
                    "type": "text",
                    "text": (
                        f"Boundary Repair Status: {'SUCCESS [GREEN]' if report.success else 'FAILED'}\n"
    ...
    elif name == "boundary_explain_drift":
