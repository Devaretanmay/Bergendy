...
def git_commit_and_push(
    ...
    subprocess.run(["git", "config", "user.name", "Boundary Bot"], cwd=repo_dir, capture_output=True)
    subprocess.run(["git", "config", "user.email", "bot@boundary.dev"], cwd=repo_dir, capture_output=True)
