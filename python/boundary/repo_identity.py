...
A repository connected to Boundary receives a persistent repository identity.
...
def _repo_store_dir() -> str:
    return os.environ.get("BOUNDARY_DIR") or os.path.expanduser("~/.boundary")
...
SALT_FILE = os.path.join(REPO_STORE_DIR, ".boundary_salt")
...
KEY_SALT = b"boundary_repo_identity_salt_v1"
