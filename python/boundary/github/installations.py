...
No database: one file per installation under ~/.boundary/installations/.
...
def store_dir() -> str:
    base = os.environ.get("BOUNDARY_INSTALLATIONS_DIR",
                           os.path.join(os.path.expanduser("~/.boundary"), "installations"))
