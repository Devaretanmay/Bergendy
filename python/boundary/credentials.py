...
"""Secure BYOK AI provider credential management for Boundary."""
...
def get_credentials_path() -> str:
    ...
    return os.environ.get("BOUNDARY_CREDENTIALS_FILE", CREDENTIALS_FILE)
...
def has_valid_credentials(installation_id: str | None = None, repo: str | None = None) -> bool:
    ...
    if (
        ...
        or os.environ.get("BOUNDARY_LLM_KEY")
    ):
        return True
...
def get_active_provider_summary() -> dict[str, Any]:
    ...
    if os.environ.get("BOUNDARY_LLM_KEY"):
        return {"configured": True, "provider": "custom", "source": "env:BOUNDARY_LLM_KEY"}
