...
Every workload Boundary governs - interactive agents, workflows, scripts,
...
_logger = logging.getLogger("boundary.engine.execution")
...
class ExecutionManager:
    """Persists and retrieves Execution domain objects under .boundary/executions/."""

    def __init__(self, workdir: str = ".") -> None:
        self.workdir = os.path.abspath(workdir)
        self.executions_dir = os.path.join(self.workdir, ".boundary", "executions")
