...
_logger = logging.getLogger("boundary.engine.integration")
...
class IntegrationEngine:
    ...
    def __init__(self, workdir: str = ".") -> None:
        ...
        self.integration_dir = os.path.join(self.workdir, ".boundary", "integration")
    ...
    def preview(self) -> str:
        ...
        if not cand:
            return "No active integration candidate. Run 'boundary integrate <lane1> <lane2>' first."

        lines = [
            "================================================================",
            f"            BOUNDARY INTEGRATION CANDIDATE #{cand.candidate_id}   ",
            "================================================================",
