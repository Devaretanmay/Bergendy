"""GitHub API Client & Authentication for Boundary App."""
...
_logger = logging.getLogger("boundary.github.client")
...
class GitHubAppClient:
    ...
    def __init__(
        ...
        self.token = token or os.environ.get("GITHUB_TOKEN") or os.environ.get("BOUNDARY_GITHUB_TOKEN") or _get_gh_cli_token()
        self.app_id = app_id or os.environ.get("BOUNDARY_GITHUB_APP_ID")
        self.private_key = private_key or os.environ.get("BOUNDARY_GITHUB_PRIVATE_KEY")
    ...
    def get_installation_access_token(self, installation_id: int) -> str | None:
        ...
        req = urllib.request.Request(
            ...
            headers={
                ...
                "User-Agent": "Boundary-Autonomous-Maintenance/1.1.0",
            },
            method="POST",
        )
        try:
    ...
    def set_commit_status(
        ...
        sha: str,
        state: str,
        context: str = "boundary/verification",
        description: str = "Boundary zero-blast-radius verified",
