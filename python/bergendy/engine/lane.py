...
Implements the GitButler-equivalent Virtual Agent Lane abstraction for Boundary.
...
class LaneManager:
    """Manages Virtual Agent Lanes under .boundary/lanes/."""

    def __init__(self, workdir: str = ".") -> None:
        self.workdir = os.path.abspath(workdir)
        self.lanes_dir = os.path.join(self.workdir, ".boundary", "lanes")
