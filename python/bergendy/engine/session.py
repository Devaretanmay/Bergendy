...
_logger = logging.getLogger("boundary.session")
...
class AgentSession:
    ...
    def format_ascii_view(self) -> str:
        ...
        lines = [
            "================================================================",
            f"              BOUNDARY AGENT SESSION #{self.session_id}          ",
            "================================================================",
...
class SessionManager:
    """Manages persistence and operations for AgentSessions under .boundary/sessions/."""

    def __init__(self, workdir: str = ".") -> None:
        self.workdir = os.path.abspath(workdir)
        self.sessions_dir = os.path.join(self.workdir, ".boundary", "sessions")
